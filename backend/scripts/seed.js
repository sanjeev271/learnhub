...
async function seed() {
  ...
  await Course.create({
    ...
    slug: 'web-development-fundamentals-' + Date.now(),
    description: 'Learn HTML, CSS, and JavaScript from scratch. Build responsive websites and understand the basics of front-end development. This comprehensive course covers everything you need to start building modern web applications.',
    shortDescription: 'A complete introduction to web development for beginners.',
    ...
    sections: [
      {
        ...
        lessons: [
          { 
            ...
            order: 0, 
            duration: 10,
            content: '<p>Welcome to web development! In this lesson, you\'ll learn about how the web works, browsers, and the role of HTML, CSS, and JavaScript.</p><p>Key topics:</p><ul><li>How websites work</li><li>Client-server architecture</li><li>Introduction to HTML, CSS, and JavaScript</li></ul>'
          },
          { 
            ...
            order: 1, 
            duration: 5,
            content: '<p>Before we start coding, let\'s set up your development environment. You\'ll need:</p><ul><li>A code editor (VS Code recommended)</li><li>A modern web browser</li><li>Basic understanding of file systems</li></ul><p>Follow the step-by-step guide to install and configure everything.</p>'
          },
          {
            ...
            order: 2,
            duration: 12,
            content: '<p>Create your very first HTML page! Learn the basic structure and essential tags.</p>'
          },
        ],
      },
      {
        ...
        lessons: [
          { 
            ...
            order: 0, 
            duration: 15,
            content: '<p>Master the fundamental HTML structure. Learn about:</p><ul><li>DOCTYPE and html tag</li><li>Head and body sections</li><li>Common HTML elements</li><li>Semantic HTML5 tags</li></ul>'
          },
          { 
            ...
            order: 1, 
            duration: 12,
            content: '<p>Build interactive forms with various input types. Learn form validation and best practices.</p>'
          },
          {
            title: 'HTML Assignment: Build a Profile Page',
            type: 'assignment',
            order: 2,
            duration: 20,
            content: '<p><strong>Assignment:</strong> Create a personal profile page using HTML. Include:</p><ul><li>Your name and photo</li><li>About section</li><li>Contact form</li><li>Links to social media</li></ul><p>Submit your HTML file for review.</p>'
          },
        ],
      },
      {
        ...
        lessons: [
          { 
            ...
            order: 0, 
            duration: 18,
            content: '<p>Learn how CSS works and how to style your HTML elements. Topics include:</p><ul><li>CSS selectors (class, ID, element)</li><li>Box model (margin, padding, border)</li><li>Colors and typography</li></ul>'
          },
          { 
            ...
            order: 1, 
            duration: 20,
            content: '<p>Master Flexbox for creating flexible layouts. Learn flex-direction, justify-content, align-items, and more.</p>'
          },
          {
            title: 'CSS Grid',
            type: 'video',
            order: 2,
            duration: 22,
            content: '<p>Build complex layouts with CSS Grid. Learn grid-template-columns, grid-template-rows, and grid areas.</p>'
          },
          {
            ...
            order: 3,
            duration: 15,
            content: '<p>Make your websites work on all devices. Learn about:</p><ul><li>Media queries</li><li>Mobile-first design</li><li>Responsive images</li><li>Viewport meta tag</li></ul>'
          },
        ],
      },
      {
        ...
        lessons: [
          {
            ...
            order: 0,
            duration: 14,
            content: '<p>Get started with JavaScript! Learn variables, data types, and basic operations.</p>'
          },
          {
            ...
            order: 1,
            duration: 16,
            content: '<p>Learn how to write functions and handle user events to make your pages interactive.</p>'
          },
          {
            ...
            order: 2,
            duration: 18,
            content: '<p>Change page content dynamically using JavaScript. Select elements, modify content, and handle events.</p>'
          },
        ],
      },
      {
            ...
            quizQuestions: [
              {
                ...
                options: ['HyperText Markup Language', 'High-Level Text Language', 'Home Tool Markup Language', 'Hyperlink Text Markup'],
                correctAnswer: 0,
              },
              {
              ...
              },
              {
                ...
                options: ['To structure content', 'To style and layout web pages', 'To add interactivity', 'To store data'],
                correctAnswer: 1,
              },
            ],
          },
  ...
  await Course.create({
    ...
    slug: 'advanced-web-development-' + Date.now(),
    description: 'Deep dive into modern frameworks, APIs, and deployment. Learn React, Node.js, REST APIs, authentication, and deploy your applications to production.',
    shortDescription: 'For developers ready to build production applications.',
    instructor: teacher._id,
    category: 'Web Development',
    difficulty: 'advanced',
    isFree: false,
  ...
  const courseData = [
    {
      ...
      description: 'Master React from basics to hooks, state management, and real-world projects. Build fast, interactive user interfaces.',
      shortDescription: 'Build fast, interactive user interfaces with React.',
      category: 'Web Development',
              ...
              quizQuestions: [
                {
                  ...
                  options: ['A state value', 'An array with state and setter', 'A function', 'An object'],
                  correctAnswer: 1,
                },
                {
    ...
    },
    {
      ...
      description: 'Build scalable REST APIs with Node.js and Express. Learn authentication, databases, and deployment.',
      shortDescription: 'Server-side JavaScript and REST APIs.',
      category: 'Web Development',
      difficulty: 'intermediate',
      isFree: true,
      price: 0,
    ...
    },
    {
      ...
      description: 'Learn Python from zero: variables, loops, functions, and your first scripts. Perfect for absolute beginners.',
      shortDescription: 'Your first steps in Python programming.',
    ...
    },
    {
      ...
      description: 'Pandas, NumPy, and basic machine learning with Python. Analyze datasets and build predictive models.',
      shortDescription: 'Analyze data and build simple ML models.',
              ...
              quizQuestions: [
                {
                  ...
                  options: ['A Python list', 'A 2D data structure in Pandas', 'A NumPy array', 'A dictionary'],
                  correctAnswer: 1,
                },
                {
    ...
    },
    {
      ...
      description: 'User research, wireframing, and design principles for better products. Learn to design interfaces users love.',
      shortDescription: 'Design interfaces users love.',
      category: 'Design',
      difficulty: 'beginner',
      isFree: true,
      price: 0,
              ...
              quizQuestions: [
                {
                  ...
                  options: ['User Experience', 'User eXchange', 'Universal eXpression', 'User eXecution'],
                  correctAnswer: 0,
                },
                {
                  question: 'What is a wireframe?',
                  options: ['A final design', 'A low-fidelity layout sketch', 'A color palette', 'A font choice'],
                  correctAnswer: 1,
                },
              ],
            },
    ...
    },
    {
      ...
      description: 'Write queries, design schemas, and work with relational databases. Master SQL fundamentals.',
      shortDescription: 'Master SQL and database basics.',
      category: 'Programming',
      difficulty: 'beginner',
      isFree: true,
      price: 0,
            ...
            { title: 'Primary and Foreign Keys', type: 'video', order: 1, duration: 12, content: '<p>Establish relationships between tables.</p>' },
            {
              ...
              quizQuestions: [
                ...
                },
                {
                  ...
                  options: ['A foreign key', 'A unique identifier for a row', 'A column name', 'A table name'],
                  correctAnswer: 1,
                },
              ],
            },
    ...
    },
    {
      ...
      description: 'Version control for your projects. Commit, branch, merge, and collaborate with teams using Git and GitHub.',
            ...
            { title: 'Pull Requests', type: 'video', order: 2, duration: 15, content: '<p>Collaborate using pull requests and code reviews.</p>' },
            {
              ...
              quizQuestions: [
                ...
                },
                {
                  ...
                  options: ['A folder', 'A separate line of development', 'A file', 'A commit'],
                  correctAnswer: 1,
                },
              ],
            },
    ...
    },
    {
      ...
      description: 'Closures, async/await, and modern JavaScript patterns. Master advanced JavaScript concepts.',
      shortDescription: 'Level up your JavaScript skills.',
      category: 'Web Development',
      difficulty: 'intermediate',
      isFree: true,
      price: 0,
              ...
              quizQuestions: [
                {
                  ...
                  options: ['A function', 'A function with access to outer scope', 'A variable', 'A loop'],
                  correctAnswer: 1,
                },
                {
                  question: 'What does async/await return?',
                  options: ['A callback', 'A Promise', 'A value', 'An error'],
                  correctAnswer: 1,
                },
                {
                  question: 'What is the purpose of a Promise?',
                  options: ['To store data', 'To handle asynchronous operations', 'To create loops', 'To define variables'],
                  correctAnswer: 1,
                },
              ],
            },
  ...
  console.log('Teacher: john@learnhub.com / teacher123');
  console.log('Student: sarah@learnhub.com / student123');
  process.exit(0);
}
